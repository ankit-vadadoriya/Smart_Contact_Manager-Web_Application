...
async function loadContactData(id) {
  ...
  try {
    ...
    // for website link
    const contactWebsiteLink = document.querySelector("#contact_website");
    if (data.websiteLink) {
      contactWebsiteLink.href = data.websiteLink;
      contactWebsiteLink.innerHTML = data.websiteLink;
    } else {
      contactWebsiteLink.innerHTML = "------";
    }
    //  for linkedIn link
